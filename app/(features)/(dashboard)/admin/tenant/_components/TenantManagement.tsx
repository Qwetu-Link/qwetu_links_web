...
function TenantStatus({ tenant }: { tenant: Tenant }) {
  return (
    <div>
      <span
      ...
      <p className="mt-2 text-xs capitalize text-slate-500">{tenant.role}</p>
    </div>
  );
}
...
export default function TenantManagement() {
  ...
  const [tenants, setTenants] = useState<Tenant[]>(seededTenants);
            ...
            >
              ...
              <div className="mt-4 grid gap-3 text-sm text-slate-600">
                ...
                <div className="rounded-lg bg-slate-50 p-3">
                  ...
                  <p className="mt-1 text-xs">{tenant.next_of_kin_phone}</p>
                </div>
                <div className="rounded-lg bg-slate-50 p-3">
                  <p className="text-xs font-semibold uppercase text-slate-400">
                    Emergency
