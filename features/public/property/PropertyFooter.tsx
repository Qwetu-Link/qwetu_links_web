...
import { footerContacts } from "@/utils/footer.config";
...
// 1️⃣ Main Wrapper Component (No data fetching happens here on admin routes)
...
// 2️⃣ Inner Content Component (Only mounts and fetches data on public pages)
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 pb-12 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {propertyList.slice(0, 5).map((property: Property) => {
              const imageUrl =
